# This model is trained on original dataset and tested on combined original and adversarial dataset.
import os
...
def setup(params):
    ...
    #Loading adversarial test datasets
    ...
    # take only 10% of the test dataset for testing
